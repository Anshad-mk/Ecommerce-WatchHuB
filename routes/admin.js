...
router.post('/addBanner', loginVerrify, (req, res, next) => {
...
router.get('/addBanner', loginVerrify, (req, res, next) => {
...
router.post('/offer', loginVerrify, (req, res, next) => {
...
router.get('/coupon', loginVerrify, (req, res, next) => {
  adminHelpers.displayCoupon().then((response) => {
    if (req.session.offererr) {
      res.render('admin/addcupon', { response, existcoupen: "Don't try to add Same CoupenName" })
...
router.post('/coupon', loginVerrify, async (req, res, next) => {
  let coupenExist = await adminHelpers.offerExist(req.body.couponID)
...
router.get('/coupen/:id', loginVerrify, (req, res, next) => {
  console.log(req.params.id)
  adminHelpers.deleteCoupen(req.params.id).then((response) => {
    res.json(response)
  })
